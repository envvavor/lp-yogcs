...
export const CTASection = () => {
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-t from-primary  relative overflow-hidden border-b-2 border-primary-foreground/10">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-4 sm:mb-6">
            Tidak Perlu <span className="text-primary">Menunda-Nunda</span>
          </h2>
